...
train_x['f_home_ground_adv'] = train_x['f_home_ground_adv'].apply(lambda x: 1.0 if x else 0.0)
train_x['f_away_ground_adv'] = train_x['f_away_ground_adv'].apply(lambda x: 1.0 if x else 0.0)

next_round_x = features_fwd_with_elo[features_fwd_with_elo.game.isin(next_week_frame.game)]

next_round_x['f_home_ground_adv'] = next_round_x['f_home_ground_adv'].apply(lambda x: 1.0 if x else 0.0)
next_round_x['f_away_ground_adv'] = next_round_x['f_away_ground_adv'].apply(lambda x: 1.0 if x else 0.0)
